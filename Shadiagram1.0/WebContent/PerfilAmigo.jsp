...
<body>
  ...
  <sql:query var="mostrar">
  	select * from amistad where usuario ="<c:out value="${usuario.usuario}"></c:out>" and amistad = "<%=request.getParameter("usuario")%>"
  </sql:query>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-5 col-sm-5 col-5">
				...
				<!-- foto perfil amigo -->
				<img
					src="fotos/<%=request.getParameter("img-perfil")%>"
					alt="..." class="imgRedonda">
			</div>
								...
								<div class="row">
									...
									<form>
										<div class=" col md-4 col-sm-4 col-4">
											<button type="submit" name="button"class="btn btn-info alinearBoton" id="amigos">Seguir</button>
										</div>
									</form>
								</div>

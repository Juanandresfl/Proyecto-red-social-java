		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5 col-sm-5 col-5">
					...
					<h6 class="alinear"><p><br></p>Publicaciones</h6>
					<h6 class="alinear" data-toggle="modal" style="cursor:pointer"
						data-target="#exampleModalCenter"><p>${usuario.amistads2.size()}</p>
					...
					<h6 class="alinear" data-toggle="modal" style="cursor:pointer"
						data-target="#exampleModalCenter1"><p>${usuario.amistads1.size()}</p>
						...
						<div class="col-md-12 col-sm-12 col-12">
							<form name="formulario" method="post"
								...
								<br> <input type="text" class="form-control"
									...
									name="descripcion" style="WIDTH: 400px"> <br>
									<input type="file" onchange="cargarArchivo(this)" name="archivo"  accept="image/*" /> 
															...
															<div class="card-body" id="scroll">
																<c:forEach var="comentario" items="${comentarios.rows}">
																	<ul class="list-group list-group-flush">
																		...
																		<b id="letra">${comentario.usuarioC}</b>
